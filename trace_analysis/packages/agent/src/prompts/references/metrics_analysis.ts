...
export const prompt: Prompt = {
  ...
  description:
    'A guide for analyzing Lynx trace metrics performance. Use this when encountering slow startup, white screen, or high latency issues. It provides diagnostic logic to identify slow stages, analyze gaps between metrics, and offer actionable optimization suggestions.',
  prompt: `# Lynx Metrics Analysis Guide
