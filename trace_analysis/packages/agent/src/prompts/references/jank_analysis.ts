...
export const prompt: Prompt = {
  name: 'jank-analysis',
  description:
    'A guide for analyzing Lynx trace smoothness issues. Use this when encountering jank, frame drops, or stuttering problems. It provides diagnostic logic to identify long tasks on Main/JS threads, analyze root causes, and offer actionable optimization suggestions.',
  prompt: `# Lynx Jank Analysis Guide
