...
export const prompt: Prompt = {
  ...
  description:
    'A reference guide for Lynx rendering pipeline stages. Use this to understand First Frame and Update rendering metrics, and to deep-dive into specific stage bottlenecks (parse, mtsrender, layout, diffVdom, etc.) with sub-event analysis and optimization strategies.',
  prompt: `# Lynx Rendering Pipeline Analysis Guide
