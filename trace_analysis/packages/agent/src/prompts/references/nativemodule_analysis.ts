...
export const prompt: Prompt = {
  ...
  description:
    'A specialized analyzer for diagnosing performance issues in `NativeModule` calls within Lynx trace. It analyzes trace events to calculate precise duration breakdowns, identifies bottlenecks in native implementation or thread scheduling, and provides actionable optimization advice.',
  prompt: `# Lynx NativeModule Performance Analysis
