...
export const prompt: Prompt = {
  name: 'diff-analysis',
  description:
    'A guide for comparing two Lynx traces to detect performance degradations or improvements. Use this when verifying optimization gains or investigating performance degradation between baseline and experiment traces.',
  prompt: `# Lynx Trace Diff Guide
