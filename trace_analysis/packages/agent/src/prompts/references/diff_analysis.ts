...
export const prompt: Prompt = {
  name: 'diff-analysis',
  description:
    'A guide for comparing two Lynx traces to detect performance regressions. Use this when verifying optimization gains or investigating performance degradation between baseline and experiment traces.',
  prompt: `# Lynx Diff Analysis Guide
