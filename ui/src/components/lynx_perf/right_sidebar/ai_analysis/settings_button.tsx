          ...
          <Form layout="vertical" style={{marginTop: '16px'}}>
            <Form.Item label="Model Provider">
              <Select
                ...
                onChange={(value) =>
                  this.updateLLMConfig('modelProvider', value)
                }
            ...
            <Form.Item label="Model Name">
              <Input
                ...
                onChange={(e) =>
                  this.updateLLMConfig('modelName', e.target.value)
                }
            ...
            <Form.Item label="Base URL (Optional)">
              <Input
                ...
                onChange={(e) =>
                  this.updateLLMConfig('baseUrl', e.target.value)
                }
            ...
            <Form.Item label="Custom Prompt (Optional)">
              <Input.TextArea
                ...
                onChange={(e) =>
                  this.updateLLMConfig('customPrompt', e.target.value)
                }
